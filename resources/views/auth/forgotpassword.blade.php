...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
		...
		<title>Bemat Admin - Forgot Password</title>
		<link rel="shortcut icon" href="../../../public/favicon.ico" type="image/x-icon">

		<!-- Bootstrap Core CSS - Include with every page -->
		<link href="../../../public/css/bootstrap.min.css" rel="stylesheet">
		<!-- Bemat Admin CSS - Include with every page -->
		<link href="../../../public/css/themes/theme-default/bemat-admin.min.css" rel="stylesheet" id="theme-switcher">
	</head>
	...
	<body id="page-authentication" class="container-fluid ">
				...
				<div class="panel panel-default">
					<div class="panel-body no-padding">
						...
						<div class="authentication-body">
							<form class="form" role="form" action="../../../public/index.html">
								<div class="form-group floating-label">
									<input type="text" class="form-control" id="email">
									<label for="email">E-mail address</label>
								</div>
								<div class="form-group">
									<button type="submit" class="btn btn-info btn-raised btn-block">Reset your password</button>
								</div>
								<div class="authentication-body-footer margin-top-5">
									<div class="text-right">
										<a href="login.blade.php">Back to log in</a>
									</div>
								</div>
							</form>
						</div>
		...
		<script src="../../../public/vendor/toasts/jquery.toasts.js" type="text/javascript"></script>
		...
		<script src="../../../public/js/bemat-admin-common.min.js"></script>
		<script src="../../../public/js/bemat-admin-demo.min.js"></script>
